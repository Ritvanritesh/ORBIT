"""Write the Phase 12A report script."""
from pathlib import Path

script = '''"""Phase 12A final comparison and report."""
import json, sys
from pathlib import Path
import numpy as np
...
Path("scripts/phase12a_report.py").write_text(script, encoding="utf-8")
print("Written report script")
